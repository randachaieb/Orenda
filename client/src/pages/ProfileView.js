...
{authContext.user.cover ?
 <div class="cover" style={{background:"no-repeat"}}>
     <img src={'http://localhost:5000'+authContext.user.cover} alt="profile-picture"/>
 <button class="glyphicon glyphicon-edit edit_cover_btn"    onClick={handleShowUp} title="edit cover photo">Edit cover photo</button>
</div>
             :
              ''
              }
...
<div className="column is-12 has-text-centered">
  <img className="profile-picture"src={'http://localhost:5000'+authContext.user.picture} alt="profile-picture"/>
  {/* Profile Name */}
    ...
    <p> you don't have bio </p>
            ...
            <div className="profile">
                <div >
                    ...
                    <button className="btn profile-edit-btn" onClick={handleShowProfile}>Edit Profile</button>
                ...
                <div className="profile-stats ">
                    ...
                    <ul>
                        <li> <span className="profile-stat-count">{ card.length}</span>{" "}posts</li>
